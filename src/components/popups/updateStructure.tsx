...
const PopupUpdateStructure: React.FC<PopupUpdateProps> = ({ onClose }) => {
  

  return (
    <div className="bg-white p-8 rounded-lg w-96 flex flex-col items-center">
      <h2 className="text-lg text-purple-950 font-semibold mb-4">Modifier Structure</h2>
...
export default PopupUpdateStructure;
